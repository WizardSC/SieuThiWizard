 ...
 */
public class RecentKhachHangGUI extends javax.swing.JDialog {
    
    private KhachHangBUS khBUS = new KhachHangBUS();
    DefaultTableModel model;

    public RecentKhachHangGUI() {
        setUndecorated(true);
        initComponents();
        this.setModal(true);
    ...
    public void xuLyLiveSearch() {
        ArrayList<KhachHangDTO> dskh = khBUS.timKiemKhachHang(txtTimKiem.getText().toString());
        showAll(dskh);
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/lblKhachHang1 32x32.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã KH" }));
